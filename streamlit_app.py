...
# --- Выбор способа ввода ---
mode = st.radio("Выберите способ ввода изображения:", [
                "Загрузить изображение", "Рисовать на холсте"])
...
if mode == "Загрузить изображение":
    ...
    if canvas_result.image_data is not None:
        image = Image.fromarray(
            (canvas_result.image_data[:, :, :3]).astype(np.uint8))
        st.image(image, caption="Нарисованное изображение",
